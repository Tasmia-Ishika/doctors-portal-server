...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.yvs4c.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
    ...
    try {
        ...
        app.get('/available', async (req, res) => {
            ...
            services.forEach(service => {
                ...
                // Step 4: find bokings for that services
